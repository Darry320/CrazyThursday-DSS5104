...
data_dir = os.path.join(os.path.dirname(os.path.dirname(script_dir)), 'data') # Directory of the data folder
...
def load_data(dataset_name,seed = 999):
    ...
    if dataset_name == 'adult':
        ...
        X_train, y_train = data_train.drop(columns=['income']), data_train['income']
